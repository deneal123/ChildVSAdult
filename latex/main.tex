...
Varying the fraction of training identities (val/test fixed), the gain saturates early: $\approx$96\% of the full FG-NET large-gap gain is reached with only 10\% of identities ($\approx$1{,}500), reaching a plateau from 25\% (Table~\ref{tab:scaling}, Fig.~\ref{fig:scaling}); the slight dip at full data (0.50$\rightarrow$1.00) lies within seed variance---the curve is flat, not monotonic, beyond $\approx$10\%. The signal is thus data-efficient; further gains require \emph{harder} data (larger gaps, hard positives) rather than merely a greater volume.
