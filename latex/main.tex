...
\caption{Small manual validation (one annotator; a sanity check, \emph{not} a certified audit---no inter-annotator $\kappa$). Samples are drawn from the curated corpus.}
\label{tab:humanval}
\centering
\footnotesize
