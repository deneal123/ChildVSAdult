...
\begin{table}[!t]
\renewcommand{\arraystretch}{1.2}
\caption{Cross-Platform Transfer: a VK-Trained Model on an Independent Reddit (Non-VK) Cross-Age Test Set (Frozen vs.\ $+$pairs, Trained on VK Only). To be completed once the Reddit set is built.}
