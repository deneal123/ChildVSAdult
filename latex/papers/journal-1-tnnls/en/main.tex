%% main.tex -- IEEE TNNLS submission (regular paper).
...
% --- CAMERA-READY author block (uncomment for the accepted version) ---
...
% --- DOUBLE-BLIND submission author block (author identity is on the separate title page) ---
